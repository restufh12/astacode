                ...
                <div class="card-body card-block">
                    <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="skill_name" name="skill_name" class="form-control @error('skill_name') is-invalid @enderror" value="{{ old('skill_name') ? old('skill_name') : $skill->skill_name }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="card-body card-block">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input name="skill_score" id="skill_score" data-slider-id='ex1Slider' type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="{{ old('skill_score') ? old('skill_score') : $skill->skill_score }}" required="">
                            </div>
                        </div>
                    </div>
                </div>
