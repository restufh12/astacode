                ...
                <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-4">
                                <input type="number" id="price" name="price" class="form-control text-right @error('price') is-invalid @enderror" value="{{ old('price') }}" required>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="UOM" class=" form-control-label">UOM</label></div>
                            <div class="col-12 col-md-4">
                                <input type="text" id="UOM" name="UOM" class="form-control @error('UOM') is-invalid @enderror" value="{{ old('UOM') }}" required>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="currency_code" class=" form-control-label">Currency Code</label></div>
                            <div class="col-12 col-md-4">
                                <input type="text" id="currency_code" name="currency_code" class="form-control @error('currency_code') is-invalid @enderror" value="{{ old('currency_code') }}">
                            </div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="best_priceYN" class=" form-control-label">Best Price YN?</label></div>
                            <div class="col-12 col-md-2">
